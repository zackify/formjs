...
var initialize = React.createClass({displayName: 'initialize',
  getInitialState: function(){
    return{ data: elements, form: form, submitText: [], action: [], method: []};

  },
  componentWillMount: function(){
    var setup = this.state.form;
    alert(this.setState({submitText: setup.submitText, action: action, method: method}));
  },
  render: function() {
