...
var generateInputField = React.createClass({displayName: 'generateInputField',
  ...
  render: function(){
    return(
      ...
      React.DOM.input( {type:this.props.type, ref:this.props.name, placeholder:this.props.placeholder, value:this.state.value, onChange:this.handleChange})
      )
    );
  }
});
...
var generateTextarea = React.createClass({displayName: 'generateTextarea',
  ...
  render: function(){
    return(
      ...
      React.DOM.label(null, this.props.label),
      React.DOM.textarea( {ref:this.props.name, placeholder:this.props.placeholder}, this.state.value)
      )
    );
  }
});
